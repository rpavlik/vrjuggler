...
foreach(_buildtype RELEASE RELWITHDEBINFO MINSIZEREL)
	set_property(DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS_${_buildtype} JUGGLER_OPT)
endforeach()
set_property(DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS_DEBUG JUGGLER_DEBUG)

# FIXME Temporary workaround until the above works
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
	add_definitions(-DJUGGLER_DEBUG)
else()
	add_definitions(-DJUGGLER_OPT -DNDEBUG)
endif()
