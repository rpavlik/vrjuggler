...
#ifndef _VPR_INET_ADDR_BOOST_H_
#define _VPR_INET_ADDR_BOOST_H_
...
/** \class InetAddrBOOST InetAddrBOOST.h vpr/IO/Socket/InetAddr.h
 *
...
public:
    ...
    * Copy constructor.
    *
    * @post A copy of the given vpr::InetAddrBOOST object is made in this
    *       object.
    *
    * @param addr The vpr::InetAddrBOOST object to be copied into this object.
    */
   InetAddrBOOST(const InetAddrBOOST& addr)
   {
      copy(addr);
   }
    ...
    */
   static vpr::InetAddrBOOST getLocalHost();
    ...
    */
   InetAddrBOOST& operator= (const InetAddrBOOST& addr)
   {
      copy(addr);
      return *this;
   }
    ...
    */
   bool operator== (const InetAddrBOOST& addr) const;
...
protected:
   friend class SocketImplBOOST;
   friend class SocketDatagramImplBOOST;
   friend class SocketStreamImplBOOST;

   /**
    * Constructs a vpr::InetAddrBOOST object from a pointer to a sockaddr
    ...
    */
   //InetAddrBOOST(const struct sockaddr* addr)
   //{
   //   setSockaddr(addr);
   //}
    ...
    *                  host byte order.
    */
   void setAddressValue(const Uint32 addrValue);
   ...
   /**
    * Makes a copy of the given vpr::InetAddrBOOST object in this object.
    *
    * @pre None.
    ...
    * @param addr The vpr::InetAddrBOOST object to be copied into this object.
    */
   void copy(const InetAddrBOOST& addr);
   ...
   boost::asio::ip::tcp::endpoint mTcpAddr;
   boost::asio::ip::udp::endpoint mUdpAddr;
   SocketTypes::Domain mFamily;
};
